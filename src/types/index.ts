...
export interface IProcedureStatus {
...
export interface IInvoiceData{
  invoice: {
    ...
    fileName: string;
    fileMime: string;
    proceduresInvoiceFile: string;
    proceduresInvoiceFileName: string;
    proceduresInvoiceFileMime: string;
  }
}

export interface ICreateHealthProfessional {
  healthProfessionals: {
    id: string;
    healthProfessionalStatusId: string;
    reasonInactivationId: string;
    careId: string;
    holisticusId: string;
    addressId: string;
    healthProfessionalTypeId: string;
