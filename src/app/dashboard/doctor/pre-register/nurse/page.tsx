...
const page = () => {
  ...
  return (
    <div className="w-full h-screen px-4">
      <div
        id="desktop"
        className="hidden md:flex justify-between items-center mb-20"
      >
        <h1 className="hidden md:flex items-center gap-2 text-2xl font-semibold text-main-blue md:ml-2">
          Administração de Serviços -{" "}
          <span className="text-lg">Enfermeira</span>
        </h1>
        <Button
      ...
      <div
        id="mobile"
        className="md:hidden flex flex-col items-start gap-2 text-2xl font-semibold text-main-blue mb-20"
      >
        <h1>Administração de Serviços</h1>
        <h2 className="text-lg">Enfermeira</h2>
        <Button
